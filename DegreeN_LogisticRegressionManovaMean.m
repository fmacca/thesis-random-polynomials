...
folder_name=strcat('Results/Degree0',int2str(N),'_LogisticRegressionManovaMean'); %Name for the results folder: it should be named after the kind of test performed
