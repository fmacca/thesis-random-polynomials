...
folder_name='Results/Degree03_LogisticRegressionGaussHZ'; %Name for the results folder: it should be named after the kind of test performed
...
% [counter r1 r2 r3 gamma Gauss_test_HZ HotT2_p]
load('Results/Degree03_NoiseCircular_ProjectionAndOthers_MULTIPLETIMES/20210809T175516/dataset.mat');
gamma = dataset(:,5);
